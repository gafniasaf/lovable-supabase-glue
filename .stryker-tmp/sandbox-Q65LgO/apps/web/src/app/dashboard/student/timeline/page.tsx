...
export default async function StudentTimelinePage() {
	...
	if (enrollmentsRes.status === 401) return <section className="p-6" aria-label="Timeline"><span><Trans keyPath="auth.notSignedIn" fallback="You are not signed in." /> <a className="underline" href="/login"><Trans keyPath="auth.signin" fallback="Sign in" /></a></span></section>;
