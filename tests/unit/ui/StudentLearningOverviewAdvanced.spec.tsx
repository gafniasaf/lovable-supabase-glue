...
import StudentLearningOverviewAdvancedPage from '@/app/labs/student/learning-overview-advanced/page';

describe('Student Learning Overview (advanced)', () => {
  ...
  it('renders cards and counts with jitter', async () => {
    ...
    const ui = await StudentLearningOverviewAdvancedPage();
    render(ui);
