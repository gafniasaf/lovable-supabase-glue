...
export const GET = withRouteTiming(async function GET(req: NextRequest) {
  ...
  try {
    ...
    const res = jsonDto(parsed, (courseVersion as any).array(), { requestId, status: 200 });
...
export const POST = withRouteTiming(async function POST(req: NextRequest) {
  ...
  try { return jsonDto(courseVersion.parse(data as any), courseVersion as any, { requestId, status: 201 }); } catch { return NextResponse.json({ error: { code: 'INTERNAL', message: 'Invalid course version shape' }, requestId }, { status: 500, headers: { 'x-request-id': requestId } }); }
});
...
export const PATCH = withRouteTiming(async function PATCH(req: NextRequest) {
  ...
  try { return jsonDto(courseVersion.parse(data as any), courseVersion as any, { requestId, status: 200 }); } catch { return NextResponse.json({ error: { code: 'INTERNAL', message: 'Invalid course version shape' }, requestId }, { status: 500, headers: { 'x-request-id': requestId } }); }
});
...
export const DELETE = withRouteTiming(async function DELETE(req: NextRequest) {
  ...
  if (data) {
    return jsonDto(data as any, courseVersion as any, { requestId, status: 200 });
  }
