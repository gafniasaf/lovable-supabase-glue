...
- main "Main content":
  - region "Outcomes":
    ...
    - textbox "course UUID": aaaaaaaa-aaaa-aaaa-aaaa-756060329720
    - button "Load"
    - link "Download CSV for course aaaaaaaa-aaaa-aaaa-aaaa-756060329720":
      - /url: /api/runtime/outcomes/export?course_id=aaaaaaaa-aaaa-aaaa-aaaa-756060329720
      - text: Download CSV
    - text: 0 rows
    - table:
      - rowgroup:
